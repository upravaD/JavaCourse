package org.example.trainee.chapter2.lesson14;
 ...
 *
 * <ul>
 *      <li><p> Объектно-ориентированное программирование использует в качестве основных
 *              логических конструктивных элементов объекты, а не алгоритмы; </p></li>
 ...
 *     в ответ на которое, объект может изменить собственное состояние.
 * </p>
 * <p>
 ...
 *     Каждый класс имеет своё имя, чтобы в будущем к нему можно было обратиться.
 *     Чтобы создать класс на Java, необходимо написать слово {@code class},
 *     дать ему название и поставить фигурные скобки: {@code class{}}.
 * </p>
...
public class ClassesAndObjects { //Основной класс программы, который совпадает с именем файла .java
    public static void main(String[] args) {
        ...
        //Инициализация полей класса Person.
        person.age = 35;
        person.name = "Иван";
...
/**
 * Подкласс программы, который представляет собой Человека и содержит в себе данные о нем.
 */
class Person {
    int age; //Возраст.
    String name; //Имя.
