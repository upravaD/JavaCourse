 ...
 *
 * <p>
 *     Возвращаемое значение — это данные (некий результат выполнения метода),
 *     которые приходят на его место после вызова.
 * </p>
 *
 * <p>
 *     Параметры - это переменные, определенные в объявлении метода после имени метода,
 *     внутри круглых скобок. Сюда входят примитивные типы, такие как int, float, boolean и т.д.,
 *     а также непримитивные или объектные типы, такие как массив, строка и т.д.
 *     Вы можете передавать значения (аргумент) параметрам метода при вызове метода.
 * </p>
 *
 * <p> Синтаксис:  </p>
 * <blockquote><pre>
...
public class Student {
    ...
    public static void main(String[] args) {
        ...
        student.initStudent(35, "Иван", "Иванов");
