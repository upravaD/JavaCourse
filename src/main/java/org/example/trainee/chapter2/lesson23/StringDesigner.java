package org.example.trainee.chapter2.lesson23;
 ...
 *
 * <p>
 *     {@code StringBuilder} – класс, предоставляющий изменяемую последовательность символов.
 *     Класс был введен в Java 5 и имеет полностью идентичный API с {@code StringBuffer}.
 *     Единственное отличие – {@code StringBuilder} не синхронизирован.
 *     Это означает, что его нежелательно использовать в многопоточных средах.
 * </p>
 *
 * @author upravaD
 * @version JDK 18
