 ...
 *
 * <p>
 *     Сеттер — метод, используемый в объектно-ориентированном программировании для
 *     присвоения какого-либо значения инкапсулированному полю, например,
 *     обработав при этом недопустимые присваивания.
 *     Часто реализуется в паре с методом - геттером, позволяющим получать значение поля класса.
 * </p>
 *
...
class User {
    ...
    /**
     * Статический метод, который создает объект {@code User}
     * и инициализирует его поля значениями, введенными с клавиатуры.
     * @param scanner Принимает значения введенные с клавиатуры.
...
class Address {
    ...
    /**
     * Статический метод, который создает объект {@code Address}
     * и инициализирует его поля значениями, введенными с клавиатуры.
     * @param scanner Принимает значения введенные с клавиатуры.
