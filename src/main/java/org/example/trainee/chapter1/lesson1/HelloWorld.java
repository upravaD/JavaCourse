package org.example.trainee.chapter1.lesson1;
...
public class HelloWorld { //Основной класс программы.
    ...
    /**
     * Ключевое слово public означает, что метод main() доступен везде,
     * где доступен содержащий его класс. Ключевое слово static означает,
     * что метод является статическим, т.е. не требует для своего вызова наличие экземпляра класса.
